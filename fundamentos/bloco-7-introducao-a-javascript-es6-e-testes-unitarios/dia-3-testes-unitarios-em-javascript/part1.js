...
assert.deepStrictEqual(obj1, obj2, 'objetos diferentes');
assert.notDeepStrictEqual(obj1, obj3, 'objetos iguais');
assert.notDeepStrictEqual(obj2, obj3, 'objetos iguais');
